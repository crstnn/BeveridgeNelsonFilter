const SERVER_ERROR = <>
    ...
    (e.g. different transformations or if minimum delta is set too low) or consider simpler settings (e.g. fixed delta,
    static demeaning).{' '}
    MATLAB or R code for the BN filter is also available at this <a target="_blank" rel="noopener noreferrer"
