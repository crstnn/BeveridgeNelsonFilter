...
# Note: enter in e.g. 'adjust_bands = T' and 'outliers = c(293, 294)' (obs. #'s in terms first differences) to adjusts for outlier observations when calculating error bands, F (default) for no adjustment
